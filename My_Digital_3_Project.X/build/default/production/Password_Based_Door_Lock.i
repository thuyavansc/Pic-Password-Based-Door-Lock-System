...
# 2 "<built-in>" 2
# 1 "Password_Based_Door_Lock.c" 2
# 18 "Password_Based_Door_Lock.c"
...
# 18 "Password_Based_Door_Lock.c" 2
...
char READ_SWITCHES(void)
{
 ...
 if (RB4==0) { _delay((unsigned long)((250)*(16000000/4000.0))); while (RB4==0); return '1'; }
 if (RB5==0) { _delay((unsigned long)((250)*(16000000/4000.0))); while (RB5==0); return '2'; }
 if (RB6==0) { _delay((unsigned long)((250)*(16000000/4000.0))); while (RB6==0); return '3'; }

 RB0=1; RB1=0; RB2=1; RB3=1;

 if (RB4==0) { _delay((unsigned long)((250)*(16000000/4000.0))); while (RB4==0); return '4'; }
 if (RB5==0) { _delay((unsigned long)((250)*(16000000/4000.0))); while (RB5==0); return '5'; }
 if (RB6==0) { _delay((unsigned long)((250)*(16000000/4000.0))); while (RB6==0); return '6'; }

 RB0=1; RB1=1; RB2=0; RB3=1;

 if (RB4==0) { _delay((unsigned long)((250)*(16000000/4000.0))); while (RB4==0); return '7'; }
 if (RB5==0) { _delay((unsigned long)((250)*(16000000/4000.0))); while (RB5==0); return '8'; }
 if (RB6==0) { _delay((unsigned long)((250)*(16000000/4000.0))); while (RB6==0); return '9'; }

 RB0=1; RB1=1; RB2=1; RB3=0;

 if (RB4==0) { _delay((unsigned long)((250)*(16000000/4000.0))); while (RB4==0); return '*'; }
 if (RB5==0) { _delay((unsigned long)((250)*(16000000/4000.0))); while (RB5==0); return '0'; }
 if (RB6==0) { _delay((unsigned long)((250)*(16000000/4000.0))); while (RB6==0); return '#'; }
...
# 20 "Password_Based_Door_Lock.c" 2
...
# 21 "Password_Based_Door_Lock.c" 2
...
# 22 "Password_Based_Door_Lock.c" 2
...
# 23 "Password_Based_Door_Lock.c" 2
...
void main(void)
{
    ...
    while(1)
    {
        ...
        _delay((unsigned long)((950)*(16000000/4000.0)));
